...
class FileUploadTargetFormInHiddenIframePage extends MultipleCodeExamples3Page() {

  override def pageTitle: String = "File Upload Example (hidden target form)"

  override def renderAllCodeSamples()(implicit fsc: FSContext): Unit = {
    renderCodeSampleAndAutoClosePreviousOne("Source", description = <p>This method of file upload is based on a target form that gets submitted inside a dedicated hidden iframe.</p>) {
