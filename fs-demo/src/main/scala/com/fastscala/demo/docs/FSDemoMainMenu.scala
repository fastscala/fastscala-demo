...
import com.fastscala.demo.docs.other.{AceEditorPage, LoggerUIPage}
...
object FSDemoMainMenu
  extends BSMenu(
    ...
    MenuSection("Js utils", <i class="bi bi-filetype-js"></i>.withColorDark)(new RoutingMenuItem("demo", "js", "overview")("Overview", () => new JsUtilsPage())),
    ...
    MenuSection("Table6 Library", <i class="bi bi-table"></i>.withColorPrimary)(
      ...
      new RoutingMenuItem("demo", "tables", "sortable")("Sortable", () => new SortableTableExamplePage()),
    ...
    MenuSection("Other components", <i class="bi bi-cursor"></i>.withColorSuccess)(
      new RoutingMenuItem("demo", "components", "logger-ui")("LoggerUI", () => new LoggerUIPage())
    )
  )
