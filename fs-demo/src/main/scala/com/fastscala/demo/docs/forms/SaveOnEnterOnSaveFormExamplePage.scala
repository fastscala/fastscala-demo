...
class SaveOnEnterOnSaveFormExamplePage extends MultipleCodeExamples3Page() {
      ...
      div.border.p_2.rounded.apply {
        ...
        new Form7 {
          ...
          override def onSubmitIgnoredFormAlreadySaved()(implicit fsc: FSContext): Js =
            BSToast2.Simple(<span>Form already saved!</span>)(
              <p>
                Form is already saved, submit was ignored.
              </p>
            ).positionTopRight.installAndShow()

          override def postSubmitForm()(implicit fsc: FSContext): Js = {
            BSToast2.Simple(<span>Submitted!</span>)(
              <div>
